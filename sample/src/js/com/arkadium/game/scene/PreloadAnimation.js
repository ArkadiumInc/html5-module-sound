...
PreloadAnimation = function () {
    "use strict";
    var data = "";
    if (GameSettings.currentPlatform !== GameSettings.Platforms.iOS &&
        GameSettings.currentPlatform !== GameSettings.Platforms.Android) {
        if ((navigator.userAgent.indexOf('Gecko') > -1 && navigator.userAgent.indexOf('KHTML') === -1 && GameSettings.browserName !== "msie") ||
...
module.exports = PreloadAnimation;